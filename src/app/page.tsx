  ...
  return (
    <main className="min-h-screen bg-[#0a0f1e] text-[#f9fafb]">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 py-16 sm:py-24 lg:py-36">
          <div className="flex items-center gap-3 mb-6">
            <span
              className="beacon inline-block h-2 w-2 rounded-full shrink-0"
          ...
          <h1
            className="max-w-4xl text-3xl sm:text-5xl md:text-7xl font-semibold leading-[1.05] tracking-tight"
            style={{ fontFamily: "var(--font-space-grotesk)" }}
          >
            Precision Laytime Arbitration for Global Bulk Fleets.
          </h1>
          <p className="mt-6 sm:mt-8 max-w-2xl text-base sm:text-lg text-[#9ca3af] leading-relaxed">
          ...
          <div className="mt-8 sm:mt-10 flex flex-col sm:flex-wrap sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
            <Link
              href="/sign-up"
              className="block w-full sm:w-auto text-center px-6 py-3 min-h-[48px] sm:min-h-0 flex items-center justify-center text-[#0a0f1e] font-medium transition hover:opacity-90"
            ...
            <Link
              href="/sign-in"
              className="block w-full sm:w-auto text-center border border-[#1f2937] bg-[#111827] px-6 py-3 min-h-[48px] sm:min-h-0 flex items-center justify-center text-[#f9fafb] transition hover:border-[#f59e0b]"
          ...
          {/* Stats row — stacks vertically on mobile, centered */}
          <div className="mt-12 sm:mt-20 grid grid-cols-1 md:grid-cols-3 gap-px bg-[#1f2937] border border-[#1f2937]">
            {[
              {
                stat: "$8–10B",
              ...
              <div key={i} className="bg-[#0a0f1e] p-6 sm:p-8 text-center md:text-left">
                <div
                  className="text-3xl sm:text-4xl font-semibold tnum"
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-20">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-px bg-[#1f2937] border border-[#1f2937]">
            {[
              ...
              <div key={step.n} className="bg-[#0a0f1e] p-6 sm:p-8">
                <div
                  className="text-xs tnum text-[#f59e0b] text-left"
                  style={{ fontFamily: "var(--font-jetbrains-mono)" }}
                >
                  {step.n}
                </div>
      ...
      <footer className="border-t border-[#1f2937]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-10 flex flex-col items-center justify-between gap-4 md:flex-row">
          <div className="flex flex-col md:flex-row items-center gap-2 md:gap-0">
            ...
            <span className="text-xs text-[#6b7280] md:ml-3 text-center md:text-left">
