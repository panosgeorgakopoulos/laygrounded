      ...
      <main className={styles.mainContent}>
        <div className={styles.card}>
          ...
          <div className={styles.prose}>
            ...
            <p>
              LayGrounded is a Business-to-Business (B2B) software-as-a-service platform designed to automate the extraction of data from Statements of Facts (SoFs) and calculate laytime, demurrage, and despatch claims based on configured Charter Party clauses.
            </p>
            ...
            <p>
              <strong>2.2 Verification Required:</strong> While we strive for absolute accuracy through our proprietary algorithms, the automated parsing of unstructured PDFs (SoFs) and application of complex Charter Party clauses (e.g., GENCON, ASBATANKVOY) inherently carries a margin of error. <strong>You acknowledge and agree that it is solely your responsibility to review, audit, and verify all calculations, parsed dates, and applied clauses generated by LayGrounded before using them for commercial billing, arbitration, legal disputes, or any other professional capacity.</strong>
            </p>
            <p>
